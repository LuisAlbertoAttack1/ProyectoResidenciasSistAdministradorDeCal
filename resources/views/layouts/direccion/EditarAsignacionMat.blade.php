...
<div class="container">
    <div class="row">
        <div class="col">
            <h1 class="display-5 text-center mt-4">Editar Asignacion De Materia</h1>
            <hr>
            ...
            <div class="row row-cols-1 row-cols-md-3 g-4">
                ...
                <div class="col">
                    ...
                    <div class="d-grid gap-2 col-12 mx-auto">
                        <button class="btn btn-outline-primary mb-3"><i class="fa-solid fa-address-book"></i> Registrar</button>
