                    ...
                    <tbody> 
                        @foreach($consulta as $horario)
                            <tr>
                                ...
                                <td class="align-middle"><a href="{{route('docente.prev',$horario['id_horario'])}}" class="btn btn-outline-success btn-sm"><i class="fa-solid fa-arrow-up-from-bracket"></i></td>
                            </tr>
                        @endforeach                       
                    </tbody>              
                </table>
