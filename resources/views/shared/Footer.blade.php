    ...
    <div class="container">
        <div class="row justify-content-around">
            ...
            <div class="order-2 order-md-1 col-md-5 text-center text-md-end align-self-center">
                ...
                <p class="lead TamDeLetras"><b><i class="fa-solid fa-phone me-2"></i>Tel: 55-17-09-66-17</b></p>
            </div>
            ...
            <div class="order-3 order-md-3 col-md-5 text-center text-md-start align-self-center">
                <p class="lead TamDeLetras mb-0"><b><i class="fa-solid fa-map-location-dot me-2"></i>Dirección</b></p>
